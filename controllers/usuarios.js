...
function modificarUsuario(req, res, next) {
  ...
  Usuario.findById(req.usuario.id).then(user => {
    ...
    if (typeof nuevaInfo.calificacion !== 'undefined')
      user.calificacion = nuevaInfo.calificacion
    if (typeof nuevaInfo.comentarios !== 'undefined')
      user.comentarios = nuevaInfo.comentarios
    if (typeof nuevaInfo.librosEnIntercambio !== 'undefined')
      user.librosEnIntercambio = nuevaInfo.librosEnIntercambio
    if (typeof nuevaInfo.librosEnIntercambio !== 'undefined')
      user.librosEnIntercambio = nuevaInfo.librosEnIntercambio
    if (typeof nuevaInfo.historialDeIntercambios !== 'undefined')
      user.historialDeIntercambios = nuevaInfo.historialDeIntercambios
    if (typeof nuevaInfo.fotoDeUsuario !== 'undefined')
      user.fotoDeUsuario = nuevaInfo.fotoDeUsuario
